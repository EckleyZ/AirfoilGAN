...
#%% Load the dataset
PerformanceData = np.load("D:\\MyWork\\Independent\\HPC Research\\Airfoil_Performance_Data.npy")
CoordinateData = np.load("D:\\MyWork\\Independent\\HPC Research\\Airfoil_Coordinate_Data.npy")


#%% Testing the model
# noise = tf.random.normal([1,201])
s = 3
