...
class Autoencoder(Model):
  def __init__(self, latent_dim):
    ...
    # Deconvolution 1 ---- (None,10,10,64) --> (None,21,12,32)
...
#%% Plot the decoded data (not really images but they should look similar) (only used CL, CD, and CM as R, G, and B
n = 66
